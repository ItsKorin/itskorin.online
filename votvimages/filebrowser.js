    ...
    currentFiles.forEach(file => {
        ...
        if (file.type === 'directory') {
            ...
            if (/\.(png|jpe?g|gif|webp)$/i.test(file.name)) {
                ...
                thumbImg.src = '/votvimages/pub/' + file.path;
            ...
            // Add audio player for audio files
                ...
                audio.controls = true;
                audio.src = '/votvimages/pub/' + file.path;
            ...
            downloadLink.href = '/votvimages/pub/' + file.path;
            ...
            if (file.name.match(/\.(txt|md|html?|json|js|css|xml)$/i)) {
                ...
                viewLink.href = '/votvimages/pub/' + file.path;
